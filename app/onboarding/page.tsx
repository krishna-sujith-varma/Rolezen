...
export default function OnboardingIntentPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0B0F19] text-[#0F172A] dark:text-[#F8FAFC] selection:bg-[#DCFCE7] selection:text-[#16A34A] flex flex-col justify-between p-4 sm:p-6 lg:p-8 font-sans relative overflow-hidden select-none transition-colors">
      ...
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-[#0F172A]/5 dark:bg-[#16A34A]/5 rounded-full blur-3xl pointer-events-none" />

      {/* Glassmorphic Backdrop Overlay behind Card */}
      <div className="fixed inset-0 bg-white/40 dark:bg-[#0B0F19]/60 backdrop-blur-xl pointer-events-none z-0" />

      {/* Top Header */}
      <header className="relative z-10 max-w-4xl mx-auto w-full flex items-center justify-between py-4 border-b border-[#E2E8F0]/80 dark:border-slate-800">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <span className="text-xs font-bold text-[#64748B] dark:text-slate-400">Step {step} of {totalSteps}</span>
            <div className="w-20 sm:w-24 h-2 bg-[#E2E8F0] dark:bg-slate-800 rounded-full overflow-hidden">
              <div
      ...
      <main className="relative z-10 max-w-xl mx-auto w-full my-auto py-8">
        <motion.div
          ...
          className="bg-white/95 dark:bg-[#0F172A]/95 backdrop-blur-2xl border border-[#E2E8F0] dark:border-slate-800 rounded-3xl p-6 sm:p-10 shadow-2xl shadow-slate-900/10 space-y-8"
        >
          {/* STEP 1: Primary Goal */}
          {step === 1 && (
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-xs text-[#64748B] dark:text-slate-400">
                  We will customize your AI Copilot prompts and layout engine
                </p>
              </div>
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        ...
                        isSelected
                          ? 'border-[#16A34A] bg-[#DCFCE7]/40 dark:bg-emerald-950/40 shadow-xs'
                          : 'border-[#E2E8F0] dark:border-slate-800 hover:border-[#CBD5E1] dark:hover:border-slate-700 bg-white/80 dark:bg-slate-900/40'
                      )}
                    >
                      <div className={cn('p-2.5 rounded-xl text-white shrink-0', isSelected ? 'bg-[#16A34A]' : 'bg-[#0F172A] dark:bg-slate-800')}>
                        <Icon className="h-5 w-5" />
                      </div>
                      <div className="flex-1 space-y-1">
                        <h4 className="text-sm font-bold text-[#0F172A] dark:text-white">{item.title}</h4>
                        <p className="text-xs text-[#64748B] dark:text-slate-400 leading-relaxed">{item.desc}</p>
                      </div>
                    </div>
                  );
                })}
          ...
          {step === 2 && (
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-xs text-[#64748B] dark:text-slate-400">
                  This tunes the AI Bullet Generator for your industry keywords
                </p>
              </div>
              ...
              <div className="space-y-4">
                <Input
                  ...
                  className="h-12 text-sm font-semibold bg-white/90 dark:bg-slate-900/60"
                />
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          targetRole === role
                            ...
                            : 'bg-white dark:bg-slate-800 text-[#0F172A] dark:text-slate-200 border-[#E2E8F0] dark:border-slate-700 hover:bg-[#F8FAFC] dark:hover:bg-slate-700'
                        )}
                      >
                        {role}
                      </button>
          ...
          {step === 3 && (
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-xs text-[#64748B] dark:text-slate-400">
                  Ensures appropriate page length & layout density
                </p>
              </div>
          ...
          {step === 4 && (
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-xs text-[#64748B] dark:text-slate-400">
                  Your workspace will launch tuned to solve this bottleneck
                </p>
              </div>
          ...
          {/* Action Buttons */}
          <div className="flex items-center justify-between pt-4 border-t border-[#E2E8F0] dark:border-slate-800">
            {step > 1 ? (
              <Button
                variant="ghost"
                size="sm"
                ...
                onClick={handleBack}
                className="text-xs font-semibold dark:text-slate-400 dark:hover:text-white"
              >
                Back
              </Button>
            ) : <div />}
