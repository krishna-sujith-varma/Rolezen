    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl bg-[#0F172A] text-white p-8 sm:p-14 lg:p-16 text-center space-y-8 shadow-2xl"
        >
          {/* Glow Backdrop */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[#16A34A]/20 rounded-full blur-3xl pointer-events-none" />
