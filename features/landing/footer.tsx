...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#0F172A] text-white border-t border-[#1E293B] pt-16 pb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <p className="text-sm text-[#94A3B8] leading-relaxed max-w-sm">
              The AI-powered Resume Studio that combines Resume Building, ATS Analysis, and AI Content Optimization into one unified workspace.
            </p>
